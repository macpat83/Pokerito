...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Here is the computer's card" + computerCard);
        ...
        */
        ...
        if (yourCard == card1) {
            yourMatches++;
        } else if (yourCard == card2) {
            yourMatches++;
        } else if (yourCard == card3) {
            yourMatches++;

        }else if (yourCard == card4) {
            yourMatches++;
        }else if (yourCard == card5) {
            yourMatches++;
        }else if (computerCard == card1) {
            computerMatches++;
        }else if (computerCard == card2) {
            computerMatches++;
        }else if (computerCard == card3) {
            computerMatches++;
        }else if (computerCard == card4) {
            computerMatches++;
        }else if (computerCard == card5) {
            computerMatches++;
        }
         ...
         scan.close();
            ...
            switch ((int)randomNumber) {
                ...
                case 13: return "   _____\n" +
                                ...
                                "  | |%%%|\n"+ 
                                "  |_%%%>|\n";
                default: return "Please provide a proper number";
